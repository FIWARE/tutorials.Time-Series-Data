...
-   [Start Up](#start-up)
-   [Connecting FIWARE to a Crate-DB Database via Quantum Leap](#connecting-fiware-to-a-crate-db-database-via-quantum-leap)
    -   [Crate-DB Database Server Configuration](#crate-db-database-server-configuration)
    -   [Quantum Leap Configuration](#quantum-leap-configuration)
...
tutorial has introduced the [STH-Comet](http://fiware-sth-comet.readthedocs.io/)
generic enabler for persisting and querying historic context data using a
**Mongo-DB** database.
...
-   The Operations for port for Quantum Leap - `8668` is where the service will
...
**Quantum Leap** will persist data into separate tables within the **Crate-DB**
