...
data into a range of databases such as **MySQL** and **PostgreSQL**. using [Apache Flume](https://github.com/Fiware/tutorials.Historic-Context) and [Apache NIFI](https://github.com/Fiware/tutorials.Historic-Context) Furthermore, the
